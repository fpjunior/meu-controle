    ...
    <Layout>
      ...
      {isCreating && (
        <form onSubmit={handleSubmit} className="bg-gray-50 p-6 rounded-lg mb-6 space-y-4">
          ...
          <div>
            <label className="block text-sm font-medium mb-1">Descri��o *</label>
            <textarea
          ...
          <div>
            <label className="block text-sm font-medium mb-1">Observa��es</label>
            <textarea
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label className="block text-sm font-medium mb-1">Data de Implanta��o</label>
              <input
                type="date"
          ...
          <button type="submit" className="bg-green-600 text-white px-6 py-2 rounded hover:bg-green-700">
            {isEditing ? 'Salvar Altera��es' : 'Criar RM'}
          </button>
        </form>
      )}
